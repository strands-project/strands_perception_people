...
#include "cudaHOG.h"
#include "groundHOG/Detections.h"
...
void render_bbox_2D(groundHOG::Detections& detections, QImage& image, int r, int g, int b, int lineWidth)
{
...
//  unsigned char image
 QImage image_rgb(&msg->data[0], msg->width, msg->height, QImage::Format_RGB888);
  ...
  if(returnPrepare)
  {
   ...
   groundHOG::Detections detections;
...
int main(int argc, char **argv)
{
  ...
  pub_message = n.advertise<groundHOG::Detections>(pub_topic.c_str(), 10);
